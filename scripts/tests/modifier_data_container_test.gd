...
var modifier_data_container: ModifierEffectDataContainer
...
func get_valid_buff_test():
	var modifier_data: ModifierEffect = modifier_data_container.get_buff("Thorned Armor")
...
func get_valid_debuff_test():
	var modifier_data: ModifierEffect = modifier_data_container.get_debuff("Slow")
	assert(is_instance_valid(modifier_data))
...
func _ready():
	modifier_data_container = ModifierEffectDataContainer.new()
